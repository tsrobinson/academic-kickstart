...
\begin{enumerate}
  ...
  \item ``Who should be first in line for the COVID-19 vaccine? Surveys in 13 countries of the public’s preferences for prioritisation''. With Raymond Duch et al (part of the international collaborative project \href{https://oxford-candour.com/}{CANDOUR}). 

  \item ``Efficient Multiple Imputation for Diverse Data in Python and R: \textbf{MIDASpy} and \textbf{rMIDAS}". With Ranjit Lall. \textit{In process of re-submission}.
